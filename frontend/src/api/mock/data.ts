  ...
  policies: [
    {
      ...
      name: '노후 하수관 정비',
      cost: 25,
      scoreEffects: { ecology: 12, citizen: 6, monitoring: 4 },
      pledgeArea: 'CLEAN UP',
    ...
    },
    {
      ...
      name: '하천 정화시설 확대',
      cost: 30,
      scoreEffects: { ecology: 16, citizen: 5, monitoring: 3 },
      pledgeArea: 'CLEAN UP',
      directlyReducesBod: true,
    },
    {
      ...
      name: '오염원 유입 긴급 차단',
      cost: 20,
      scoreEffects: { ecology: 10, citizen: 4, monitoring: 14 },
      pledgeArea: 'CLEAN UP',
      directlyReducesBod: true,
    },
    {
      ...
      name: '생태하천 복원',
      cost: 25,
      scoreEffects: { ecology: 28, citizen: 12, monitoring: 2 },
      pledgeArea: 'CLEAN UP',
      directlyReducesBod: true,
    },
    {
    ...
    },
    {
      ...
      name: '주민 참여 모니터링',
      cost: 10,
      scoreEffects: { ecology: 5, citizen: 16, monitoring: 18 },
      pledgeArea: 'SMART UP',
      directlyReducesBod: false,
    },
    {
...
export const mockSimulationResult = {
  ...
  budgetUsed: 80,
  remainingBudget: 20,
  scores: { ecology: 68, citizen: 50, monitoring: 61 },
  event: {
    id: 'DOWNSTREAM_ODOR_SURGE',
    name: '하류 악취 신고 급증',
    triggerPolicyCount: 2,
  ...
  playerProfile: {
    ...
    scores: { waterQuality: 100, ecology: 54, citizen: 29, monitoring: 44 },
  },
  isDemoData: true,
